 ...
 * @param {*} res 
 */
const getDialogDeleted = async (req, res) => {
  ...
  try {
    const rows = await ds_conf.getDialogDeleted(ns, testing);
    ...
    console.log(`=========${logiD} GET deleted dialog client:${client}===========`);
    const resMessages = {
      type: "API",
      status_code: code.SUCCESS_ZERO,
      status_msg: "Succeeded get deleted dialog.",
      messages
    };
