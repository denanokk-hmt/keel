 ...
 *  date:[date] 省略可能
********************************/
var systemJsonArrayLog = function (type, body, stdoutFlag=true, writingFlag=false, date) {
  //date
  if (!date) {
    date = dateformat(new Date(), 'yyyymmdd-HH:MM:ss:l');
  }
  //Message
  const msg = {
    type: type,
...
module.exports.systemJSON = systemJsonArrayLog;
